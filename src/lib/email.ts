...
export async function sendOtpEmail(payload: SendOtpPayload): Promise<void> {
  ...
  const senderName = import.meta.env.VITE_BREVO_SENDER_NAME || "Somnity";
  const logoUrl = 
  ...
  const subject = payload.subject || "Your Somnity verification code";
  const html = `
    <!DOCTYPE html>
<html>
<head>
  ...
  <title>Somnity Verification Code</title>
  <style>
...
<body style="margin:0;padding:0;background-color:#0a0a0a;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;">
  <div style="max-width:600px;margin:0 auto;background-color:#111111;border-radius:16px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,0.4);border:1px solid #1f1f1f;">
    ...
    <div style="background-color:#000000;padding:48px 24px;text-align:center;position:relative;">
      <img src="${logoUrl}" alt="Somnity" style="height:96px;width:auto;margin-bottom:16px;filter:brightness(1.2);" />
      <h1 style="color:#ffffff;margin:0;font-size:32px;font-weight:700;letter-spacing:-0.025em;">Somnity</h1>
    ...
    <div style="padding:48px 32px;background-color:#111111;">
      ...
      <p style="color:#71717a;margin:0;font-size:14px;line-height:1.5;text-align:center;">
        This email was sent by Somnity. For security reasons, please do not share this code with anyone.
      </p>
    </div>
